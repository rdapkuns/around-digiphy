...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function tS(s,e,t){const n=new Float32Array(xs),i=new G(0,1,0);return new wr({name:"SphericalGaussianBlur",defines:{n:xs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Nc(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function Cp(){return new wr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nc(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function Pp(){return new wr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nc(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function Nc(){return`
	...
	`}function nS(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Ef||l===wf,u=l===Eo||l===wo;if(c||u){let f=e.get(a);const h=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new oh(s)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),f.texture;if(f!==void 0)return f.texture;{const d=a.image;return c&&d&&d.height>0||u&&d&&i(d)?(t===null&&(t=new oh(s)),f=c?t.fromEquirectangular(a):t.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),a.addEventListener("dispose",r),f.texture):null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function iS(s){const e={};function t(n){if(e[n]!==void 0)return e[n];const i=s.getExtension(n);return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&za("WebGLRenderer: "+n+" extension not supported."),i}}}function rS(s,e,t,n){const i={},r=new WeakMap;function o(f){const h=f.target;h.index!==null&&e.remove(h.index);for(const _ in h.attributes)e.remove(h.attributes[_]);h.removeEventListener("dispose",o),delete i[h.id];const d=r.get(h);d&&(e.remove(d),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(f,h){return i[h.id]===!0||(h.addEventListener("dispose",o),i[h.id]=!0,t.memory.geometries++),h}function l(f){const h=f.attributes;for(const d in h)e.update(h[d],s.ARRAY_BUFFER)}function c(f){const h=[],d=f.index,_=f.attributes.position;let g=0;if(d!==null){const M=d.array;g=d.version;for(let x=0,b=M.length;x<b;x+=3){const w=M[x+0],T=M[x+1],S=M[x+2];h.push(w,T,T,S,S,w)}}else if(_!==void 0){const M=_.array;g=_.version;for(let x=0,b=M.length/3-1;x<b;x+=3){const w=x+0,T=x+1,S=x+2;h.push(w,T,T,S,S,w)}}else return;const m=new(w0(h)?L0:P0)(h,1);m.version=g;const p=r.get(f);p&&e.remove(p),r.set(f,m)}function u(f){const h=r.get(f);if(h){const d=f.index;d!==null&&h.version<d.version&&c(f)}else c(f);return r.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function sS(s,e,t){let n;function i(h){n=h}let r,o;function a(h){r=h.type,o=h.bytesPerElement}function l(h,d){s.drawElements(n,d,r,h*o),t.update(d,n,1)}function c(h,d,_){_!==0&&(s.drawElementsInstanced(n,d,r,h*o,_),t.update(d,n,_))}function u(h,d,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,r,h,0,_);let m=0;for(let p=0;p<_;p++)m+=d[p];t.update(m,n,1)}function f(h,d,_,g){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)c(h[p]/o,d[p],g[p]);else{m.multiDrawElementsInstancedWEBGL(n,d,0,r,h,0,g,0,_);let p=0;for(let M=0;M<_;M++)p+=d[M]*g[M];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function oS(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:lt("WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function aS(s,e,t){const n=new WeakMap,i=new vt;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let h=n.get(a);if(h===void 0||h.count!==f){let y=function(){S.dispose(),n.delete(a),a.removeEventListener("dispose",y)};h!==void 0&&h.texture.dispose();const d=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,g=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],M=a.morphAttributes.color||[];let x=0;d===!0&&(x=1),_===!0&&(x=2),g===!0&&(x=3);let b=a.attributes.position.count*x,w=1;b>e.maxTextureSize&&(w=Math.ceil(b/e.maxTextureSize),b=e.maxTextureSize);const T=new Float32Array(b*w*4*f),S=new A0(T,b,w,f);S.type=qn,S.needsUpdate=!0;const A=x*4;for(let v=0;v<f;v++){const C=m[v],P=p[v],N=M[v],U=b*w*4*v;for(let V=0;V<C.count;V++){const B=V*A;d===!0&&(i.fromBufferAttribute(C,V),T[U+B+0]=i.x,T[U+B+1]=i.y,T[U+B+2]=i.z,T[U+B+3]=0),_===!0&&(i.fromBufferAttribute(P,V),T[U+B+4]=i.x,T[U+B+5]=i.y,T[U+B+6]=i.z,T[U+B+7]=0),g===!0&&(i.fromBufferAttribute(N,V),T[U+B+8]=i.x,T[U+B+9]=i.y,T[U+B+10]=i.z,T[U+B+11]=N.itemSize===4?i.w:1)}}h={count:f,texture:S,size:new ht(b,w)},n.set(a,h),a.addEventListener("dispose",y)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let d=0;for(let g=0;g<c.length;g++)d+=c[g];const _=a.morphTargetsRelative?1:1-d;l.getUniforms().setValue(s,"morphTargetBaseInfluence",_),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",h.size)}return{update:r}}function lS(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,f=e.get(l,u);if(i.get(f)!==c&&(e.update(f),i.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;i.get(h)!==c&&(h.update(),i.set(h,c))}return f}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}const W0=new hn,Lp=new B0(1,1),X0=new A0,q0=new $x,Y0=new N0,Dp=[],Ip=[],Np=new Float32Array(16),Up=new Float32Array(9),Fp=new Float32Array(4);function Go(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=Dp[i];if(r===void 0&&(r=new Float32Array(i),Dp[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function on(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function an(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Uc(s,e){let t=Ip[e];t===void 0&&(t=new Int32Array(e),Ip[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function cS(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function uS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(on(t,e))return;s.uniform2fv(this.addr,e),an(t,e)}}function fS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(on(t,e))return;s.uniform3fv(this.addr,e),an(t,e)}}function hS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(on(t,e))return;s.uniform4fv(this.addr,e),an(t,e)}}function dS(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(on(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),an(t,e)}else{if(on(t,n))return;Fp.set(n),s.uniformMatrix2fv(this.addr,!1,Fp),an(t,n)}}function pS(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(on(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),an(t,e)}else{if(on(t,n))return;Up.set(n),s.uniformMatrix3fv(this.addr,!1,Up),an(t,n)}}function mS(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(on(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),an(t,e)}else{if(on(t,n))return;Np.set(n),s.uniformMatrix4fv(this.addr,!1,Np),an(t,n)}}function gS(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function _S(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(on(t,e))return;s.uniform2iv(this.addr,e),an(t,e)}}function xS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(on(t,e))return;s.uniform3iv(this.addr,e),an(t,e)}}function vS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(on(t,e))return;s.uniform4iv(this.addr,e),an(t,e)}}function yS(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function bS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(on(t,e))return;s.uniform2uiv(this.addr,e),an(t,e)}}function MS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(on(t,e))return;s.uniform3uiv(this.addr,e),an(t,e)}}function SS(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(on(t,e))return;s.uniform4uiv(this.addr,e),an(t,e)}}function TS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Lp.compareFunction=E0,r=Lp):r=W0,t.setTexture2D(e||r,i)}function ES(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||q0,i)}function wS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Y0,i)}function AS(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||X0,i)}function RS(s){switch(s){case 5126:return cS;case 35664:return uS;case 35665:return fS;case 35666:return hS;case 35674:return dS;case 35675:return pS;case 35676:return mS;case 5124:case 35670:return gS;case 35667:case 35671:return _S;case 35668:case 35672:return xS;case 35669:case 35673:return vS;case 5125:return yS;case 36294:return bS;case 36295:return MS;case 36296:return SS;case 35678:case 36198:case 36298:case 36306:case 35682:return TS;case 35679:case 36299:case 36307:return ES;case 35680:case 36300:case 36308:case 36293:return wS;case 36289:case 36303:case 36311:case 36292:return AS}}function CS(s,e){s.uniform1fv(this.addr,e)}function PS(s,e){const t=Go(e,this.size,2);s.uniform2fv(this.addr,t)}function LS(s,e){const t=Go(e,this.size,3);s.uniform3fv(this.addr,t)}function DS(s,e){const t=Go(e,this.size,4);s.uniform4fv(this.addr,t)}function IS(s,e){const t=Go(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function NS(s,e){const t=Go(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function US(s,e){const t=Go(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function FS(s,e){s.uniform1iv(this.addr,e)}function OS(s,e){s.uniform2iv(this.addr,e)}function BS(s,e){s.uniform3iv(this.addr,e)}function kS(s,e){s.uniform4iv(this.addr,e)}function zS(s,e){s.uniform1uiv(this.addr,e)}function VS(s,e){s.uniform2uiv(this.addr,e)}function HS(s,e){s.uniform3uiv(this.addr,e)}function GS(s,e){s.uniform4uiv(this.addr,e)}function WS(s,e,t){const n=this.cache,i=e.length,r=Uc(t,i);on(n,r)||(s.uniform1iv(this.addr,r),an(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||W0,r[o])}function XS(s,e,t){const n=this.cache,i=e.length,r=Uc(t,i);on(n,r)||(s.uniform1iv(this.addr,r),an(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||q0,r[o])}function qS(s,e,t){const n=this.cache,i=e.length,r=Uc(t,i);on(n,r)||(s.uniform1iv(this.addr,r),an(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||Y0,r[o])}function YS(s,e,t){const n=this.cache,i=e.length,r=Uc(t,i);on(n,r)||(s.uniform1iv(this.addr,r),an(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||X0,r[o])}function KS(s){switch(s){case 5126:return CS;case 35664:return PS;case 35665:return LS;case 35666:return DS;case 35674:return IS;case 35675:return NS;case 35676:return US;case 5124:case 35670:return FS;case 35667:case 35671:return OS;case 35668:case 35672:return BS;case 35669:case 35673:return kS;case 5125:return zS;case 36294:return VS;case 36295:return HS;case 36296:return GS;case 35678:case 36198:case 36298:case 36306:case 35682:return WS;case 35679:case 36299:case 36307:return XS;case 35680:case 36300:case 36308:case 36293:return qS;case 36289:case 36303:case 36311:case 36292:return YS}}class jS{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=RS(t.type)}}class $S{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=KS(t.type)}}class ZS{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const yu=/(\w+)(\])?(\[|\.)?/g;function Op(s,e){s.seq.push(e),s.map[e.id]=e}function JS(s,e,t){const n=s.name,i=n.length;for(yu.lastIndex=0;;){const r=yu.exec(n),o=yu.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){Op(t,c===void 0?new jS(a,s,e):new $S(a,s,e));break}else{let f=t.map[a];f===void 0&&(f=new ZS(a),Op(t,f)),t=f}}}class Zl{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);JS(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function Bp(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const QS=37297;let e1=0;function t1(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const kp=new Qe;function n1(s){dt._getMatrix(kp,dt.workingColorSpace,s);const e=`mat3( ${kp.elements.map(t=>t.toFixed(4))} )`;switch(dt.getTransfer(s)){case uc:return[e,"LinearTransferOETF"];case wt:return[e,"sRGBTransferOETF"];default:return Fe("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function zp(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+t1(s.getShaderSource(e),a)}else return r}function i1(s,e){const t=n1(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function r1(s,e){let t;switch(e){case ax:t="Linear";break;case lx:t="Reinhard";break;case cx:t="Cineon";break;case ux:t="ACESFilmic";break;case hx:t="AgX";break;case dx:t="Neutral";break;case fx:t="Custom";break;default:Fe("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Al=new G;function s1(){dt.getLuminanceCoefficients(Al);const s=Al.x.toFixed(4),e=Al.y.toFixed(4),t=Al.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function o1(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ua).join(`
`)}function a1(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function l1(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function ua(s){return s!==""}function Vp(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Hp(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const c1=/^[ \t]*#include +<([\w\d./]+)>/gm;function ah(s){return s.replace(c1,f1)}const u1=new Map;function f1(s,e){let t=tt[e];if(t===void 0){const n=u1.get(e);if(n!==void 0)t=tt[n],Fe('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ah(t)}const h1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Gp(s){return s.replace(h1,d1)}function d1(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Wp(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function p1(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===h0?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===d0?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===hr&&(e="SHADOWMAP_TYPE_VSM"),e}function m1(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Eo:case wo:e="ENVMAP_TYPE_CUBE";break;case Cc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function g1(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case wo:e="ENVMAP_MODE_REFRACTION";break}return e}function _1(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case p0:e="ENVMAP_BLENDING_MULTIPLY";break;case sx:e="ENVMAP_BLENDING_MIX";break;case ox:e="ENVMAP_BLENDING_ADD";break}return e}function x1(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function v1(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=p1(t),c=m1(t),u=g1(t),f=_1(t),h=x1(t),d=o1(t),_=a1(r),g=i.createProgram();let m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
`;continue}if((B=V.match(v))&&(U.gamma=parseFloat(B[1])),(B=V.match(C))&&(U.exposure=parseFloat(B[1])),(B=V.match(P))&&(U.valid|=2,U.format=B[1]),(B=V.match(N))&&(U.valid|=4,U.height=parseInt(B[1],10),U.width=parseInt(B[2],10)),U.valid&2&&U.valid&4)break}return U.valid&2||o(3,"missing format specifier"),U.valid&4||o(3,"missing image size specifier"),U},d=function(A,y,v){const C=y;if(C<8||C>32767||A[0]!==2||A[1]!==2||A[2]&128)return new Uint8Array(A);C!==(A[2]<<8|A[3])&&o(3,"wrong scanline width");const P=new Uint8Array(4*y*v);P.length||o(4,"unable to allocate buffer space");let N=0,U=0;const V=4*C,B=new Uint8Array(4),K=new Uint8Array(V);let W=v;for(;W>0&&U<A.byteLength;){U+4>A.byteLength&&o(1),B[0]=A[U++],B[1]=A[U++],B[2]=A[U++],B[3]=A[U++],(B[0]!=2||B[1]!=2||(B[2]<<8|B[3])!=C)&&o(3,"bad rgbe scanline format");let ee=0,D;for(;ee<V&&U<A.byteLength;){D=A[U++];const Ae=D>128;if(Ae&&(D-=128),(D===0||ee+D>V)&&o(3,"bad scanline data"),Ae){const Oe=A[U++];for(let Be=0;Be<D;Be++)K[ee++]=Oe}else K.set(A.subarray(U,U+D),ee),ee+=D,U+=D}const le=C;for(let Ae=0;Ae<le;Ae++){let Oe=0;P[N]=K[Ae+Oe],Oe+=C,P[N+1]=K[Ae+Oe],Oe+=C,P[N+2]=K[Ae+Oe],Oe+=C,P[N+3]=K[Ae+Oe],N+=4}W--}return P},_=function(A,y,v,C){const P=A[y+3],N=Math.pow(2,P-128)/255;v[C+0]=A[y+0]*N,v[C+1]=A[y+1]*N,v[C+2]=A[y+2]*N,v[C+3]=1},g=function(A,y,v,C){const P=A[y+3],N=Math.pow(2,P-128)/255;v[C+0]=cl.toHalfFloat(Math.min(A[y+0]*N,65504)),v[C+1]=cl.toHalfFloat(Math.min(A[y+1]*N,65504)),v[C+2]=cl.toHalfFloat(Math.min(A[y+2]*N,65504)),v[C+3]=cl.toHalfFloat(1)},m=new Uint8Array(e);m.pos=0;const p=h(m),M=p.width,x=p.height,b=d(m.subarray(m.pos),M,x);let w,T,S;switch(this.type){case qn:S=b.length/4;const A=new Float32Array(S*4);for(let v=0;v<S;v++)_(b,v*4,A,v*4);w=A,T=qn;break;case qi:S=b.length/4;const y=new Uint16Array(S*4);for(let v=0;v<S;v++)g(b,v*4,y,v*4);w=y,T=qi;break;default:throw new Error("THREE.HDRLoader: Unsupported type: "+this.type)}return{width:M,height:x,data:w,header:p.string,gamma:p.gamma,exposure:p.exposure,type:T}}setDataType(e){return this.type=e,this}load(e,t,n,i){function r(o,a){switch(o.type){case qn:case qi:o.colorSpace=En,o.minFilter=Qt,o.magFilter=Qt,o.generateMipmaps=!1,o.flipY=!0;break}t&&t(o,a)}return super.load(e,r,n,i)}}var Sn,C_,Tr,$i,$r,P_,So,Wl,L_=function(){return typeof window<"u"},D_=function(){return Sn||L_()&&(Sn=window.gsap)&&Sn.registerPlugin&&Sn},I_=function(e){return typeof e=="string"},c0=function(e){return typeof e=="function"},$a=function(e,t){var n=t==="x"?"Width":"Height",i="scroll"+n,r="client"+n;return e===Tr||e===$i||e===$r?Math.max($i[i],$r[i])-(Tr["inner"+n]||$i[r]||$r[r]):e[i]-e["offset"+n]},Za=function(e,t){var n="scroll"+(t==="x"?"Left":"Top");return e===Tr&&(e.pageXOffset!=null?n="page"+t.toUpperCase()+"Offset":e=$i[n]!=null?$i:$r),function(){return e[n]}},Ww=function(e,t,n,i){if(c0(e)&&(e=e(t,n,i)),typeof e!="object")return I_(e)&&e!=="max"&&e.charAt(1)!=="="?{x:e,y:e}:{y:e};if(e.nodeType)return{y:e,x:e};var r={},o;for(o in e)r[o]=o!=="onAutoKill"&&c0(e[o])?e[o](t,n,i):e[o];return r},N_=function(e,t){if(e=P_(e)[0],!e||!e.getBoundingClientRect)return console.warn("scrollTo target doesn't exist. Using 0")||{x:0,y:0};var n=e.getBoundingClientRect(),i=!t||t===Tr||t===$r,r=i?{top:$i.clientTop-(Tr.pageYOffset||$i.scrollTop||$r.scrollTop||0),left:$i.clientLeft-(Tr.pageXOffset||$i.scrollLeft||$r.scrollLeft||0)}:t.getBoundingClientRect(),o={x:n.left-r.left,y:n.top-r.top};return!i&&t&&(o.x+=Za(t,"x")(),o.y+=Za(t,"y")()),o},u0=function(e,t,n,i,r){return!isNaN(e)&&typeof e!="object"?parseFloat(e)-r:I_(e)&&e.charAt(1)==="="?parseFloat(e.substr(2))*(e.charAt(0)==="-"?-1:1)+i-r:e==="max"?$a(t,n)-r:Math.min($a(t,n),N_(e,t)[n]-r)},Oh=function(){Sn=D_(),L_()&&Sn&&typeof document<"u"&&document.body&&(Tr=window,$r=document.body,$i=document.documentElement,P_=Sn.utils.toArray,Sn.config({autoKillThreshold:7}),So=Sn.config(),C_=1)},Xo={version:"3.13.0",name:"scrollTo",rawVars:1,register:function(e){Sn=e,Oh()},init:function(e,t,n,i,r){C_||Oh();var o=this,a=Sn.getProperty(e,"scrollSnapType");o.isWin=e===Tr,o.target=e,o.tween=n,t=Ww(t,i,e,r),o.vars=t,o.autoKill=!!("autoKill"in t?t:So).autoKill,o.getX=Za(e,"x"),o.getY=Za(e,"y"),o.x=o.xPrev=o.getX(),o.y=o.yPrev=o.getY(),Wl||(Wl=Sn.core.globals().ScrollTrigger),Sn.getProperty(e,"scrollBehavior")==="smooth"&&Sn.set(e,{scrollBehavior:"auto"}),a&&a!=="none"&&(o.snap=1,o.snapInline=e.style.scrollSnapType,e.style.scrollSnapType="none"),t.x!=null?(o.add(o,"x",o.x,u0(t.x,e,"x",o.x,t.offsetX||0),i,r),o._props.push("scrollTo_x")):o.skipX=1,t.y!=null?(o.add(o,"y",o.y,u0(t.y,e,"y",o.y,t.offsetY||0),i,r),o._props.push("scrollTo_y")):o.skipY=1},render:function(e,t){for(var n=t._pt,i=t.target,r=t.tween,o=t.autoKill,a=t.xPrev,l=t.yPrev,c=t.isWin,u=t.snap,f=t.snapInline,h,d,_,g,m;n;)n.r(e,n.d),n=n._next;h=c||!t.skipX?t.getX():a,d=c||!t.skipY?t.getY():l,_=d-l,g=h-a,m=So.autoKillThreshold,t.x<0&&(t.x=0),t.y<0&&(t.y=0),o&&(!t.skipX&&(g>m||g<-m)&&h<$a(i,"x")&&(t.skipX=1),!t.skipY&&(_>m||_<-m)&&d<$a(i,"y")&&(t.skipY=1),t.skipX&&t.skipY&&(r.kill(),t.vars.onAutoKill&&t.vars.onAutoKill.apply(r,t.vars.onAutoKillParams||[]))),c?Tr.scrollTo(t.skipX?h:t.x,t.skipY?d:t.y):(t.skipY||(i.scrollTop=t.y),t.skipX||(i.scrollLeft=t.x)),u&&(e===1||e===0)&&(d=i.scrollTop,h=i.scrollLeft,f?i.style.scrollSnapType=f:i.style.removeProperty("scroll-snap-type"),i.scrollTop=d+1,i.scrollLeft=h+1,i.scrollTop=d,i.scrollLeft=h),t.xPrev=t.x,t.yPrev=t.y,Wl&&Wl.update()},kill:function(e){var t=e==="scrollTo",n=this._props.indexOf(e);return(t||e==="scrollTo_x")&&(this.skipX=1),(t||e==="scrollTo_y")&&(this.skipY=1),n>-1&&this._props.splice(n,1),!this._props.length}};Xo.max=$a;Xo.getOffset=N_;Xo.buildGetter=Za;Xo.config=function(s){So||Oh()||(So=Sn.config());for(var e in s)So[e]=s[e]};D_()&&Sn.registerPlugin(Xo);Pe.registerPlugin($e,Xo);let pn,_t,Di;const la=document.querySelector(".three-canvas");let Dt=6,Xl=1,In={value:4};Xw();F_();async function Xw(){pn=new xv,pn.background=null,_t=new Fn(65,la.clientWidth/la.clientHeight,.1,100),_t.position.set(17,Dt,-8),_t.lookAt(0,Dt-4,0),Di=new j1({canvas:la,antialias:!0,alpha:!0}),Di.setSize(la.clientWidth,la.clientHeight),Di.setPixelRatio(window.devicePixelRatio);const s=new sh(16777215,1);s.position.set(15,7,17.5),s.castShadow=!0,s.shadow.mapSize.set(2048,2048);const e=new sh(16777215,.5);e.position.set(25,7,27.5),e.castShadow=!0,e.shadow.mapSize.set(4096,4096);const t=e.shadow.camera;t.near=.5,t.far=200,t.left=-30,t.right=30,t.top=30,t.bottom=-30,t.updateProjectionMatrix();const n=new oh(Di);new Gw().load("hdri/sunset.hdr",u=>{const f=n.fromEquirectangular(u).texture;pn.environment=f,u.dispose(),n.dispose(),pn.backgroundBlurriness=.05,pn.backgroundIntensity=.2,pn.environmentIntensity=.1});const i=v_(pn),r=R_(pn);pn.add(i.group),pn.add(r.group);const{accessoryGroups:o,setAccessoryVariant:a}=await Vw(pn),l={value:12565940,roughness:.1,metalness:.1},c={value:12565940,roughness:.1,metalness:.1};t3(_t),fw("#accessory-menu",o,a,l,c)}function qw(){Di.outputColorSpace=sn,Di.toneMapping=yr,Di.toneMappingExposure=1,Di.shadowMap.enabled=!0,Di.shadowMap.type=d0,Di.render(pn,_t)}function Yw(){const s=window.innerWidth,e=window.innerHeight;_t.aspect=s/e,_t.updateProjectionMatrix(),Di.setSize(s,e)}Pe.to(".canvas-wrapper",{ease:"linear",scrollTrigger:{trigger:".three-section",start:"top top",end:"bottom bottom",pin:".canvas-wrapper"}});const U_=19,Kw=63,ks={first:1,hold:6,last:4.2},jw=_t.position.y,$w=jw+Kw,ns=Pe.timeline({scrollTrigger:{trigger:".three-section",start:"top top",end:"bottom bottom",scrub:!0,onUpdate:()=>{Dt=_t.position.y,_t.lookAt(0,Dt-In.value,0),Jw(),ac.checkHeight(Dt,Lt),lc.checkHeight(Dt,Lt),console.log(Dt)}}});ns.to(_t.position,{y:U_,ease:"linear",duration:ks.first});ns.call(()=>{console.log("ENTERED HOLD"),b_()});ns.to(_t.position,{y:U_,ease:"none",duration:ks.hold},"holdStart");ns.call(()=>{b_(),Pe.to(_t,{fov:20,duration:1,ease:"power3.inOut",onUpdate(){_t.updateProjectionMatrix()}}),Pe.to(In,{value:2,duration:1,ease:"power3.inOut",onUpdate(){_t.lookAt(0,Dt-In.value,0)}}),hw()},null,"holdStart+="+ks.hold*.2);ns.call(()=>{y_()},null,"holdStart+="+ks.hold*.75);ns.call(()=>{y_()},null,"holdStart+="+ks.hold*.95);ns.to(_t.position,{y:$w,ease:"linear",duration:ks.last});ns.call(()=>{},null,"holdStart+="+ks.hold);const Zw=document.querySelector(".qr-wrapper"),f0=document.querySelector(".overlay-button-container"),ac=v_(pn),pf=uw(pn),Li=pw(pn),mf=Bw(pn),lc=R_(pn);document.querySelector(".overlay-button").addEventListener("click",Li.toggleOverlayOpacity);function Jw(){const s=Math.floor(Dt/13.3)+1;s!==Xl&&(console.log("new floor: ",s),s===1&&(Pe.to(_t,{fov:65,duration:1,ease:"power3.inOut",onUpdate(){_t.updateProjectionMatrix()}}),Pe.to(In,{value:4,duration:1,ease:"power3.inOut",onUpdate(){_t.lookAt(0,Dt-In.value,0)}})),s===2&&(Lt===0&&pf.rotateFloor(0),Lt===1&&pf.rotateFloor(120),Lt===2&&pf.rotateFloor(-120),Li.hideUI("#ui-panel-3-1"),Li.hideUI(".floor3-ui-container .ui-tip")),s===3&&(Lt===0&&Li.rotateFloor(0),Lt===1&&Li.rotateFloor(120),Lt===2&&Li.rotateFloor(-120),f0.classList.remove("visually-hidden"),Li.showUI("#ui-panel-3-1"),Li.showUI(".floor3-ui-container .ui-tip"),mf.hideQR(),Pe.to(_t,{fov:30,duration:1,ease:"power3.inOut",onUpdate(){_t.updateProjectionMatrix()}}),Pe.to(In,{value:2,duration:1,ease:"power3.inOut",onUpdate(){_t.lookAt(0,Dt-In.value,0)}})),s===4&&(Zw.classList.remove("visually-hidden"),Li.hideUI("#ui-panel-3-1"),Li.hideUI(".floor3-ui-container .ui-tip"),mf.showQR(),Pe.to(_t,{fov:30,duration:1,ease:"power3.inOut",onUpdate(){_t.updateProjectionMatrix()}}),Pe.to(In,{value:2,duration:1,ease:"power3.inOut",onUpdate(){_t.lookAt(0,Dt-In.value,0)}})),s===5&&(mf.hideQR(),Pe.to(_t,{fov:65,duration:1,ease:"power3.inOut",onUpdate(){_t.updateProjectionMatrix()}}),Pe.to(In,{value:4,duration:1,ease:"power3.inOut",onUpdate(){_t.lookAt(0,Dt-In.value,0)}}),zw()),s===6&&kw(),(s===2||s===4)&&(f0.classList.add("visually-hidden"),Li.overlayOff()),s===2&&Xl===3&&(Pe.to(_t,{fov:20,duration:1,ease:"power3.inOut",onUpdate(){_t.updateProjectionMatrix()}}),Pe.to(In,{value:2,duration:1,ease:"power3.inOut",onUpdate(){_t.lookAt(0,Dt-In.value,0)}})),Xl=s,e3(Xl))}const Qw=document.querySelectorAll(".nav-button");function e3(s){Qw.forEach(t=>t.classList.remove("nav-active"));const e=document.querySelector(`.nav-button[data-floor="floor${s}"]`);e&&e.classList.add("nav-active")}let Lt;function t3(s,e){const t=[new G(0,Dt,23),new G(20,Dt,-10),new G(-20,Dt,-10)];Lt=0;let n=!1;function i(r){n=!0,Pe.to(s.position,{x:r.x,y:Dt,z:r.z,duration:1.5,ease:"power2.inOut",onStart:()=>{ac.checkHeight(Dt,-1),lc.checkHeight(Dt,-1)},onUpdate:()=>{s.lookAt(0,Dt-In.value,0)},onComplete:()=>{ac.checkHeight(Dt,Lt),lc.checkHeight(Dt,Lt),n=!1}})}ac.checkHeight(Dt,Lt),lc.checkHeight(Dt,Lt),s.position.copy(t[Lt]),s.lookAt(0,Dt-In.value,0),window.addEventListener("keydown",r=>{n||(r.key==="ArrowRight"?(Lt=(Lt+1)%t.length,i(t[Lt])):r.key==="ArrowLeft"&&(Lt=(Lt-1+t.length)%t.length,i(t[Lt])))}),document.querySelector(".horizontal-controls-right").addEventListener("click",()=>{Lt=(Lt+1)%t.length,i(t[Lt])}),document.querySelector(".horizontal-controls-left").addEventListener("click",()=>{Lt=(Lt-1+t.length)%t.length,i(t[Lt])})}window.addEventListener("resize",Yw);function F_(){requestAnimationFrame(F_),qw()}window.addEventListener("load",()=>{$e.refresh(),Hw(_t)});
